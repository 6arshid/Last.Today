            ...
            <div class="mx-auto max-w-lg">
              <div class="py-2">
                ...
                <input name="username"
                    ...
                    type="text" required class="text-md block px-3 py-2  rounded-lg w-full 
              ...
              <div class="py-2" x-data="{ show: true }">
                ...
                <div class="relative">
                  <input placeholder="Enter Your Password" id="password"
                    ...
                    type="password"  required class="text-md block px-3 py-2 rounded-lg w-full 
              ...
              <div class="flex justify-between"><label class="block text-gray-500 font-bold my-4">
                ...
                <span class="py-2 text-sm text-gray-600 leading-snug"> Remember
                    Me </span></label> <label class="block text-gray-500 font-bold my-4">
                         <Link v-if="canResetPassword" :href="route('password.request')" class="cursor-pointer tracking-tighter text-black border-b-2 border-gray-200 hover:border-gray-400">
               <span>Forgot your password?</span>     
                </Link>
                       </label></div> 
                 <JetButton class="ml-4" :class="`mt-3 text-lg font-semibold 
                btn-primary w-full text-white rounded-lg
                px-6 py-3 block shadow-xl hover:text-white hover:bg-black`" :disabled="form.processing">
                    Log in
                </JetButton>
            </div>
          </form>
          <p tabindex="0" class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Dont have account? 
                        <a href="/register"   class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer">
                             Register</a></p> 
